...
class Relatorio {
    ...
    /**
     * M�todo para setar o alterar cor de fundo.
     * @param string $exibir Se a ser� alternada a cor [true|false]
     * @param string $primeira_cor Primeira cor das cores alternadas, padr�o [#FFFFFF]
     * @param string $segunda_cor Segunda cor das cores alternadas, padr�o [#F2F2F2]
     */
    ...
    /**
     * M�todo para definir link para uma coluna
     * @param string $coluna Para qual coluna o link est� sendo definido [$db_campo] de definirColuna()
     * @param string $link O link [href] para onde ser� redirecionado (obs: pode ser uma fun��o javascript)
     * @param integer $target [opcional valor default: 0]<p>
     * 0: para abrir o link na mesma p�gina</p><p>
    ...
    /**
     * M�todo para definir as configura��es de cada coluna a ser exibida no relat�rio 
     * @param string $descricao Descri��o da exibi��o da coluna 
     * @param string $db_campo <p>
     *  Nome do campo que vem do resultado do banco de dados ou
     *  nome de variavel a ser utilizada </p>
     * @param string $tam_coluna Tamanho da coluna para exibi��o
     * @param string $alinhamento Tipo de alinhamento do conte�do
     * @param string $tipo_coluna Tipo de conte�do que ser� exibido ['t'] ou ['0-9'] para quantidade de casas decimais
     * @param string $calc_total Se a coluna ser� calculado a somat�ria para exibir total
     * @param string $repete_valor Se a coluna exibir� valores repetidos
    ...
    /**
     * M�todo para definir as configura��es de cada quebra a ser exibida no relat�rio 
     * @param string $descricao Descri��o da exibi��o da coluna 
     * @param string $db_campo <p>
     *  Nome do campo que vem do resultado do banco de dados ou
     ...
     * @param string $cabecalho Nome do campo que vira do banco de dados para ser concatenado com a descri��o da quebra
    ...
    /**
     * Gera o cabe�alho do relat�rio criando a tabela com a descri��o de cada coluna definida em definirColuna()
     * @param integer $tamanho Tamanho da tabela do relat�rio<p>
    ...
    /**
     * M�todo respons�vel por receber uma linha do resultSet por vez e montar o corpo do relatorio 
     * @param resultSet $linha Recebe uma linha por vez para montar o relat�rio
     */
...
//        ECHO "</PRE>";
        ...
        foreach ($this->db_campo as $campo) {
            ...
            //verifica se o valor do conte�do � um numero para calcular o sub_total e total 
    ...
    /**
     * M�todo privado para alternar as cores de fundo do relat�rio 
     */
    ...
    /**
     * Verifica se a coluna possui um link e o cria caso tenha. O resultado de retorno ser� apenas um echo
     ...
     * @param string $campo O nome do campo(da coluna) que est� sempre impresso no tabela
     * @param string $valor_imprimir O valor j� formatado que ser� impresso na tabela
     * 
     */
    ...
    /**
     * Gera o rodap� do relatorio exibindo o total geral caso tenha alguma coluna de somat�ria e 
     * fecha a tabela do relat�rio
     */
    ...
    /**
     * Exibe o a �ltima linha do relatorio com a somat�ria de cada coluna definida como somatoria 
     */
    ...
    /**
     * Exibe o uma linha com a somat�ria dos valores de cada coluna definida como somatoria contidos dentro de uma quebra
     */
    ...
    /**
     * Exibe todas as quebras de p�ginas definidas por definirQuebra()
...
//                  codi��o para n�o exibir o sub-total como a primeira linha do relatorio
...
//            ap�s gerar as primeiras quebras permite exibir o subtotal            
            $this->sub_total_exibir = 1;
        }
    }

    /**
     * M�todo que recebe um valor string e traduz para uma classe de alinhamento do bootstrap
     * ou dispara uma exce��o 
     ...
     * @throws \Exception Dispara uma exce��o caso o valor do par�metro seja invalido
     */
    private function setAlinhamento($tipo = '') {
        switch ($tipo) {
            ...
            case 'right':
                ...
                break;
            default:
                throw new \Exception("O par�metro '$tipo' em setAlinhamento('$tipo') deve ser [center|left|right]");
                return "erro";
        }
    }
