...
$auth_users = array(
    'admin' => '1a7995daadc62d48550256ac4ac45170'
);
...
$root_path = str_replace('public', 'module',$_SERVER['DOCUMENT_ROOT']);
if($_GET['raiz'] == 1){
    $root_path = str_replace('public', '',$_SERVER['DOCUMENT_ROOT']);
}
                            ...
                            <form action="" method="post" autocomplete="off">
                                ...
                                <fieldset class="clearfix">
                                    ...
                                    <div style="margin-top:20px">
                                        <?php fm_show_message(); ?>
                                        <p ><span class="fa fa-user"></span><input type="text" name="fm_usr" id="fm_usr" placeholder="Usuário"></p> 
                                        <div class="invalid-feedback">Username is required</div>
                                        <p><span class="fa fa-lock"></span><input type="password" name="fm_pwd" id="fm_pwd" placeholder="Senha"></p>
                                        <div class="invalid-feedback">Password is required</div>
                                        <div style="margin-top:20px">
                                            <input type="submit" style="width:100px" value="Entrar"></span>
                                        </div>
                                    </div>
...
function fm_show_nav_path($path)
{
    global $lang;
    ?>
    <nav class="navbar navbar-light bg-light navbar-expand-lg" style="background: radial-gradient(ellipse at center, #4261a3 1%, #273043 100%)">
...
<body style="background: radial-gradient(ellipse at center, #4261a3 1%, #273043 100%); background-repeat: no-repeat;background-size: cover">
...
<head>
    ...
    <style>
        ...
        #file-tree-view::-webkit-scrollbar-thumb {
            border-radius: 10px;
            background: radial-gradient(ellipse at center, #4261a3 1%, #273043 100%);
...
<nav class="navbar p-0 pl-2 navbar-light bg-light" style="background: radial-gradient(ellipse at center, #4261a3 1%, #273043 100%);">
